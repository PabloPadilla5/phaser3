class LevelTwo extends Phaser.Scene {
	...
	preload() {
		this.load.image('bg_2', 'assets/background_2.jpg');
        this.load.image('ground', 'assets/platform.png');
        this.load.image('star', 'assets/star.png');
        this.load.image('bomb', 'assets/bomb.png');
        this.load.audio('background_music_2', 'assets/music/background_2.mp3');
	...
	create() {
        ...
        background_music = this.sound.add("background_music_2", { loop: true });
        background_music.play();

        game = this;

        //  A simple background for our game
        this.add.image(800, 400, 'bg_2');
        this.add.image(2400, 400, 'bg_2');
        this.add.image(4000, 400, 'bg_2');
        this.add.image(5600, 400, 'bg_2');
        ...
        platforms.create(1500, 350, 'ground').setScale(1.7).refreshBody();
        platforms.create(2300, 200, 'ground');
        platforms.create(2500, 500, 'ground');
        platforms.create(2800, 400, 'ground');
        platforms.create(3000, 400, 'ground').setScale(1.1).refreshBody();
